...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //根据用户名查询用户信息
        String pwd = new BCryptPasswordEncoder().encode("123123");
//        String pwd = userFeign.findByUsername(username).getData().getPassword();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(BCrypt.checkpw("zhangsan", zhangsan));
        System.out.println(new BCryptPasswordEncoder().matches("zhangsan", zhangsan));
    }
}
